...
In this module, you'll be using another training environment,  DHIS2 Customization to practice and get familiar with its options.
...
2. You need to be a computer programmer (someone who knows computer languages) to take part in the configuration of DHIS2.
*   True
*   False
...
[https://www.youtube.com/watch?v=6Enk8m9wJqc](https://www.youtube.com/watch?v=6Enk8m9wJqc)
...
In this video, you’ll continue learning about how to input new data in DHIS2. Select the play button below to get started.
...
#### Video - Data Collection - Web Demo - Part 4 of 5
...
#### Video- Data Collection - Web Demo - Part 5 of 5

[https://www.youtube.com/watch?v=kRIh4GasqIw](https://www.youtube.com/watch?v=kRIh4GasqIw)


#### Video - Data Collection - Android - Part 1 of 3
...
#### Video - Data Collection - Android Demo - Part 2 of 3
...
#### Video - Data Collection - Android Demo - Part 3 of 3

[https://www.youtube.com/watch?v=lAJ09XUkqa4](https://www.youtube.com/watch?v=lAJ09XUkqa4)


#### Video - Data Collection - PDF and CSV Import
...
PDF forms can be automatically generated by DHIS2 in order to enter data offline
...
*   False
    ...
    DHIS2 can natively import an Excel file in any format

*   True
*   False

    DHIS2 has functionality to import large amounts of data at once so this data does not need to be re-entered again
